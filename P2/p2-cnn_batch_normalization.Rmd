...
model <- keras_model_sequential() %>%
  ...
  layer_conv_2d(filters = 64, kernel_size = c(3, 3), activation = "relu") %>% layer_batch_normalization(epsilon = 0.01) %>% layer_max_pooling_2d(pool_size = c(2, 2)) %>%
...
plot(cm$table, main="Confusion matrix of CNN", sub="Two classes - medium10000")
```
